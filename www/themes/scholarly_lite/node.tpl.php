<article id="node-<?php print $node->nid; ?>" class="<?php print implode('', $classes); ?> clearfix node-mt"<?php print backdrop_attributes($attributes); ?>>
  ...
  <?php endif;?>
    ...
    <header>
      ...
      <?php if (!$page): ?>
        <h2<?php print $title_attributes; ?>><a href="<?php print implode('', $node_url); ?>"><?php print $title; ?></a></h2>
      <?php endif; ?>
